...
| **account label draft** | The name given to an account holding more than one extension: each extension's name cut down and joined with `+`, capped at 38 characters. Extensions not yet named are counted (`+ 1 more`), never guessed at. Badged `auto`; editing and saving promotes it. |
